  ...
  return (
    <div className="flex w-full gap-2">
      ...
      <div className="w-[45%] text-right">
        <span className="text-background text-xs2 font-favoritMedium leading-none tracking-tight">
          {label}
        </span>
      </div>
      ...
      <div className="w-[55%] flex items-center gap-2">
        ...
        <div
          className="flex justify-end items-center h-full bg-background rounded-full pl-2"
